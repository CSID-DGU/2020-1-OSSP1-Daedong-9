...
html = req.text
soup = BeautifulSoup(html, 'html.parser') # 오류 체크
...
if 'None' in str(ErrorCheck):
    print("Error! 지역 검색 오류!")
        ...
        tomorrowCheck = tomorrowArea.find_all('div', {'class': 'main_info morning_box'}) # 내일 오전온도
        ...
        tomorrowMoring = tomorrowMoring1 + tomorrowMoring2 # 내일 오전상태
        ...
        tomorrowMState = tomorrowMState3 + " " + tomorrowMState5 # 내일 오후온도
        ...
        tomorrowAfter = tomorrowAfter2 + tomorrowAfter3 # 내일 오후상태
